...
export const UsersOnboardingConfig: OnboardingStep[] = [
    {
        ...
        content: (
            <Typography.Paragraph>
                <p>
                    Welcome to Visa Data Catalog <strong>Users</strong>!
                </p>
                <p>
                    There are a few different ways to onboard new <strong>Users</strong> onto Visa Data Catalog.
                </p>
            </Typography.Paragraph>
        ),
    },
        ...
        content: (
            <Typography.Paragraph>
                <p>
                    ...
                    Currently, Visa Data Catalog supports OIDC SSO.
                </p>
                <p>
    ...
    },
    {
        ...
        content: (
            <Typography.Paragraph>
                <p>
                    Easily share an invite link with your colleagues to onboard them onto Visa Data Catalog. Optionally
